...
import { resolveEscalationById } from '../../_lib/alerts-store.js'
...
export default async function handler(req, res) {
  ...
  try {
    const { escalation } = await resolveEscalationById(req.query.id, req.body || {})
    ...
    return jsonResponse(res, 500, {
      error: error.message || 'Failed to resolve escalation',
      code: 'ESCALATION_RESOLVE_FAILED',
    })
  }
}
