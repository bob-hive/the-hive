...
import { retryEscalation } from '../../_lib/alerts-store.js'
...
export default async function handler(req, res) {
  ...
  try {
    const { escalation } = await retryEscalation(req.query.id, req.body || {})
    ...
    return jsonResponse(res, 500, {
      error: error.message || 'Failed to retry escalation',
      code: 'ESCALATION_RETRY_FAILED',
    })
  }
}
